  ...
  const userSubmitAddressData = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `/api/auth/add-address/?id=${userId}`,
        {
          userId: userId,
      ...
      <div className="px-4 my-12">
        ...
        >
              ...
              <div className="p-2 col-span-3">
                <article>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    >
                      <i className="bx bx-plus text-center text-xl rounded-full h-6 w-6 flex items-center justify-center bg-blue-500 text-white transition-all duration-150 cursor-pointer "></i>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {user.addressDetails.map((item, index) => (
                      <div key={index}>
                        <label className="flex p-3 border border-gray-200 rounded-md bg-gray-50 hover:border-blue-400 hover:bg-blue-50 cursor-pointer has-[:checked]:bg-indigo-50  has-[:checked]:bg-in-500">
                          <span>
                            <input
                              name="shipping"
                              type="radio"
          ...
          <aside className="col-span-5 lg:col-span-2 bg-gray-100 p-4 flex flex-col rounded-md">
            ...
            <button type="submit" className="py-3 px-3 w-full bg-orange-500 hover:bg-orange-600 my-4 text-white rounded-md">
